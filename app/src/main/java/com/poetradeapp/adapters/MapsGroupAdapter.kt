...
class MapsGroupAdapter(
    ...
    private var items: Map<String?, List<CurrencyViewData>> = mapOf()
    ...
    fun updateItems(items: Map<String?, List<CurrencyViewData>>) {
        this.items = items
...
class MapsGroupViewHolder(
    ...
    fun bind(groupName: String?, items: List<CurrencyViewData>) {
