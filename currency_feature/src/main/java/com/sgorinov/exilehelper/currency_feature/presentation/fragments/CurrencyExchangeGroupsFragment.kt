...
import com.sgorinov.exilehelper.currency_feature.databinding.FragmentCurrencyExchangeGroupsBinding
...
internal class CurrencyExchangeGroupsFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = getBinding()
        binding.toolbarLayout.toolbar.title = "Select currency_feature group"
